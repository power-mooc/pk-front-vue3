  ...
  <div class="pb-15">
    ...
    <Container>
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 w-full lt-sm:px-4 py-4">
        <a :href="item.url" target="_blank" v-for="(item, index) in recommend" :key="index" class="flex">
          <Card
          ...
          >
            <template #default>
              <div class="px-2 py-1 lg:(px-4 mb-4) flex items-center justify-start text-gray-500 text-xs lg:text-base">
    ...
    <Container class="flex-col">
      ...
      <!-- Grid -->
      <div class="grid grid-cols-2 py-4 lt-sm:px-4 sm:grid-cols-3 lg:(grid-cols-6 grid-rows-2 ) gap-3">
        <!-- 左侧 row*2 col*2 -->
...
const recommend = ref([
  {
    image: bg,
    title: '第四期开始报名了！行业风口、政策倾斜，新晋热门高薪不内卷！打通从0基础到高薪就业完整路径，抢占先发优势！',
    comments: '9',
  ...
  {
    image: bg,
    title: '以一线互联网公司产品标准，打造适合零基础学习的全干货Java课程。选择Java，高薪就业的第一步！',
    comments: '9',
